 ...
 * @Description: 
 * @Author: liangrongjun
 * @Date: 2021-10-19 15:17:59
 * @LastEditors: liangrongjun
 * @LastEditTime: 2021-10-19 15:19:04
-->
# Contributing in @alan89757

We'd always love contributions to further improve the webpack / alan89757 ecosystem!
...
{
  "devDependencies": {
    "uitest-loader": "alan89757/uitest-loader#{id}/head"
  }
}
```
...
When submitting your contribution, a CLA (Contributor License Agreement) bot will come by to verify that you signed the [CLA](https://cla.js.foundation/alan89757/uitest-loader).
